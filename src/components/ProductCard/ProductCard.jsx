...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      <div className="group bg-gray-900 rounded-2xl shadow-xl overflow-hidden flex flex-col
       h-full transition  duration-500 transform border
        border-gray-800 hover:scale[1.03] hover:shadow-orange-900/40">
        ...
        <div className="p-5 flex flex-col grow">
          ...
          <div className="flex item-center text-gray-500 text-xs mb-4 ">
