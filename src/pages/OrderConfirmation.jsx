      ...
      <div className="container mx-auto md:px-8 pt-12">
        <div className="p-12 bg-gray-900 rounded-3xl shadow-2xl max-w-2xl mx-auto 
          ...
          <p className="text-lg text-gray-300 mb-6 ">
            Your Transacation is Complate. A Confirmation email has been sent your Account.
          </p>
          <div className="p-6 bg-green-900/30 border border-green-700 rounded-xl font-mono 
          text-left inline-block text-green-300 text-sm  ">
          ...
          <Link to={'/'}
            className=" mt-10 px-4 py-4 bg-orange-600 text-white font-extrabold  rounded-full
